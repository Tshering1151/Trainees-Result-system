...
<body>
    <header class="header">
        <img src="<?php echo e(asset('images/logo-left.png')); ?>" alt="Institute Logo" class="logo left">
        <div class="title">
            <h1>༄༅།། རྒྱལ་གཞུང་འཛིན་སྐྱོང་སློབ་སྡེ།</h1>
            <h1>ROYAL INSTITUTE OF MANAGEMENT</h1>
            <p>management for growth & development</p>
        </div>
        <img src="<?php echo e(asset('images/logo-right.png')); ?>" alt="Institute Logo" class="logo right">
    </header>
    
    <h2 class="system-title"><?php echo $__env->yieldContent('header'); ?>
...
</html><?php /**PATH C:\xampp\htdocs\Demo-project\resources\views/components/layout.blade.php ENDPATH**/ ?>