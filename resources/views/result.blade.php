...
@section('title', 'Trainees Results')
...
<script>
    ...
    function validateAndRedirect() {
        ...
        window.location.href = `{{ url('/add_result') }}?course_id=${courseId}&rim_id=${rimId}&term=${term}`;
    }
    ...
    function validateAndRedirectCSV() {
        ...
        window.location.href = `{{ url('/upload_result') }}?course_id=${courseId}&term=${term}`;
    }
</script>
